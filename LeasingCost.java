public class LeasingCost {
	...
	public static Vehicle createVehicle(String description){
        //name
        description.substring("name:");
        description.indexOf(";");
        //lease
        description.substring("due:");
        description.indexOf(";");
        description.substring("length:");
        description.indexOf(";");
        description.substring("monthly:");
        description.indexOf(";");
        description.substring("allowance:");
        description.indexOf(";");
        //gas
        description.substring("type:");
        description.indexOf(";");
        description.substring("mile/unit:");
        description.indexOf(";");
	...
	public static void computeCO2EmissionsAndCost( Vehicle[] vehicles, double gasPrice, double electricityPrice ){
            ...
            electricityPrice = computeFuelCost();
            }

            public double getLease() {
            return computeLeaseCost();
            }
            public void setLease(double lease) {
            this.lease = lease;
            lease = computeLeaseCost();
            }
            ...
            //numberOfMonths = computeFuelCost();
            }

            public double getMileageAllowance() {
            return mileageAllowance;
            }
            public void setMileageAllowance(double mileageAllowance) {
            ...
            public double getUsuage() {
            return usage;
            }
            public void setUsuage( double usage) {
            this.usage = usage;
            }
